...
$.Donut2D = $.extend($.Pie, {
	...
	configure : function() {
		...
		this.set({
			/**
			 * @cfg {Number} Specifies the width when show a donut.If the value lt 1,It will be as a percentage,value will be radius*donutwidth.only applies when it not 0.(default to 0.3) 改变饼图中心留白大小
			 */
			donutwidth : 0.7,
			/**
